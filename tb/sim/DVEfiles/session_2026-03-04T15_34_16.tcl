...
# DVE full session
# Saved on Wed Mar 4 15:34:16 2026
# Designs open: 1
...
catch { gui_list_select -id ${Data.1} {tb_top.axi_vif.assert_awvalid_stable tb_top.axi_vif.assert_wvalid_stable tb_top.axi_vif.assert_arvalid_stable tb_top.axi_vif.assert_bvalid_until_bready tb_top.axi_vif.assert_rvalid_until_rready tb_top.axi_vif.clk tb_top.axi_vif.rst_n tb_top.axi_vif.awaddr tb_top.axi_vif.awready tb_top.axi_vif.wdata tb_top.axi_vif.wstrb tb_top.axi_vif.wvalid tb_top.axi_vif.wready tb_top.axi_vif.bready tb_top.axi_vif.bvalid tb_top.axi_vif.bresp tb_top.axi_vif.araddr tb_top.axi_vif.arvalid tb_top.axi_vif.arready tb_top.axi_vif.rready tb_top.axi_vif.rdata tb_top.axi_vif.rvalid tb_top.axi_vif.rresp tb_top.axi_vif.led_out tb_top.axi_vif.sevenseg_out tb_top.axi_vif.irq_out {tb_top.axi_vif.$unit} }}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 6577000
...
gui_marker_move -id ${Wave.1} {C1} 1164524
