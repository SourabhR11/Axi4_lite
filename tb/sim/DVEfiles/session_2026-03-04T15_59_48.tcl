...
# DVE full session
# Saved on Wed Mar 4 15:59:48 2026
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{3 78} {1916 1125}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 173} {height 788} {dock_state left} {dock_on_new_line true} {child_hier_colhier 111} {child_hier_coltype 54} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 438} {height 788} {dock_state left} {dock_on_new_line true} {child_data_colvariable 232} {child_data_colvalue 99} {child_data_coltype 99} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 361} {child_wave_right 934} {child_wave_colname 186} {child_wave_colvalue 171} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sg_addsignal -group "$_session_group_1" { tb_top.axi_vif.assert_awvalid_stable tb_top.axi_vif.assert_wvalid_stable tb_top.axi_vif.assert_arvalid_stable tb_top.axi_vif.assert_bvalid_until_bready tb_top.axi_vif.assert_rvalid_until_rready tb_top.axi_vif.clk tb_top.axi_vif.rst_n tb_top.axi_vif.awvalid tb_top.axi_vif.awready tb_top.axi_vif.awaddr tb_top.axi_vif.wstrb tb_top.axi_vif.wvalid tb_top.axi_vif.wready tb_top.axi_vif.wdata tb_top.axi_vif.bready tb_top.axi_vif.bvalid tb_top.axi_vif.bresp tb_top.axi_vif.arvalid tb_top.axi_vif.arready tb_top.axi_vif.araddr tb_top.axi_vif.rready tb_top.axi_vif.rvalid tb_top.axi_vif.rdata tb_top.axi_vif.rresp tb_top.axi_vif.led_out tb_top.axi_vif.sevenseg_out tb_top.axi_vif.irq_out {tb_top.axi_vif.$unit} }
...
gui_wv_zoom_timerange -id ${Wave.1} 99099 1042607
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {tb_top.axi_vif.awaddr }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group1  -item {tb_top.axi_vif.awaddr[31:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 345000
